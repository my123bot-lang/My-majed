...
عند حضورك اسأل عن الموظف ماجد`,
  ...
  session: {
    ...
    /**
     * كلمات بدء/إعادة الرد الآلي — فقط: مرحبا / هلا / السلام عليكم / 1
     * تُطابق كبداية للرسالة لا نصاً مطابقاً بالكامل (مثلاً "السلام عليكم ورحمة الله").
     * «1» يفتح القائمة خارج الجلسة النشطة فقط (لا يعيد الضبط وسط الحسبة) ويبقى تطابقاً كاملاً.
     */
    restartKeywords: ["مرحبا", "هلا", "السلام عليكم"],
    menuStartKeywords: ["مرحبا", "هلا", "السلام عليكم", "1"],
    /**
