...
عند حضورك اسأل عن الموظف ماجد`,
  ...
  session: {
    ...
    /**
     * كلمات إعادة الضبط وسط الجلسة — مرحبا / هلا فقط.
     * لا تُضاف «السلام عليكم» هنا حتى لا تُصفَّر الحسبة إذا حيّا العميل أثناء الأسئلة.
     */
    restartKeywords: ["مرحبا", "هلا"],
    /**
     * كلمات بدء القائمة لعميل جديد أو بعد إغلاق الجلسة.
     * تشمل تحية السلام حتى يرد البوت فوراً على أول رسالة معتادة من العملاء.
...
للقائمة الرئيسية اكتب: مرحبا أو هلا أو 1`,
