...
### مهم: Stop داخل محادثة العميل

| التشغيل | اكتب `stop` في شات العميل | يعمل؟ |
|---------|---------------------------|-------|
| محلي `npm start` | نعم (وأي رد يدوي منك يوقف البوت لهذا العميل) | نعم |
| سحابة Interakt / Render | **لا** — Interakt لا يرسل webhook لرسائلك الصادرة | استخدم `stop` من جوالك إلى رقم البوت أو اللوحة |
