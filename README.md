...
| التشغيل | اكتب `stop` أو رد يدوياً في شات العميل | يعمل؟ |
|---------|----------------------------------------|-------|
| محلي `npm start` | نعم (وأي رد يدوي منك يوقف البوت لهذا العميل) | نعم |
| سحابة Interakt / Render | من **صندوق Interakt**: غالباً نعم (`AgentMessage`) · من **تطبيق واتساب الأعمال**: غالباً لا | بديل موثوق: `stop` من جوالك إلى رقم البوت أو زر اللوحة |
