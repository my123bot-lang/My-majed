...
/**
 * قائمة سياسة الرواتب — الترتيب: 1 مدني، 2 متقاعد، 3 عسكري
 * (يختلف عن أزرار القطاع في التمويل الشخصي).
 */
function parseSalaryPolicyChoice(text) {
  const t = normalizeText(text).toLowerCase();
  if (
    t === "1" ||
    t === "sal_civilian" ||
 ...
 * على "السلام عليكم ورحمة الله وبركاته" أو "مرحبا كيفكم" وليس فقط النص المطابق تماماً.
