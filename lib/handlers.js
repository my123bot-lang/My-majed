...
function isMenuStartTrigger(text) {
  const keywords = menuStartKeywords || [
    "مرحبا",
    "هلا",
    "أهلا",
    "اهلا",
  ...
  return matchesStartKeyword(text, keywords) || isPoliteGreeting(text);
}
...
async function handleIncomingMessage(msg) {
  ...
  // مرحبا / هلا → إعادة من أي خطوة. «السلام عليكم» يفتح القائمة لعميل جديد فقط.
